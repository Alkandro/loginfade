...
//     transform: [{ scale: withTiming(isRegister ? 0.9 : 1, { duration: 350 }) }],
//   }));

//   const registerAnim = useAnimatedStyle(() => ({
//     opacity: withTiming(isRegister ? 1 : 0, { duration: 350 }),
//     transform: [{ scale: withTiming(isRegister ? 1 : 0.9, { duration: 350 }) }],
//   }));
...
//         <Animated.View style={[styles.gradientSlider, gradientStyle]}>
//           <LinearGradient
...
export default function App() {
  ...
  const toggleForm = () => {
    const goReg = !isRegister;
    rotation.value = withTiming(goReg ? 180 : 0, {
      duration: 700,
      ...
      <Animated.View style={[styles.scene, sceneStyle]}>
        ...
        <Animated.View style={[styles.card, frontStyle]}>
          ...
          <View style={styles.linkContainer}>
            <Text style={styles.linkText}>Don't have an account?</Text>
            <TouchableOpacity onPress={toggleForm}>
              <Text style={[styles.linkButton, { color: "#ff6b4a" }]}>
                Sign Up
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <Animated.View style={[styles.card, backStyle]}>
          ...
          <View style={styles.linkContainer}>
            <Text style={styles.linkText}>Already have an account?</Text>
            <TouchableOpacity onPress={toggleForm}>
              <Text style={[styles.linkButton, { color: "#8c6bff" }]}>
                Sign In
              </Text>
            </TouchableOpacity>
          </View>
